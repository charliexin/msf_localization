#ifndef MSF_LOCALIZATION_KALMAN_FILTER_KALMAN_FILTER_HPP_
#define MSF_LOCALIZATION_KALMAN_FILTER_KALMAN_FILTER_HPP_
...
#include "msf_localization/sensor_data/imu_data.hpp"
...
public:
  ...
  enum MeasurementType {
    ...
    POSE_VEL,//匹配+组合导航的速度
    POSI,    //GPS(x,y,z)
    POSI_VEL,//GPS+组合导航的速度(速度可以做一个约束，类似encodeer)   GPS+encoder的速度
    POSI_MAG,//GPS+磁力计
    POSI_VEL_MAG,//GPS+encode+磁力计 或者GPS+组合导航的速度
    NUM_TYPES
  };
