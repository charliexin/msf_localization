...
#include "msf_localization/sensor_data/gnss_data.hpp"

#include "glog/logging.h"
#include <ostream>

//静态成员变量必须在类外初始化
double msf_localization::GNSSData::origin_latitude = 0.0;
double msf_localization::GNSSData::origin_longitude = 0.0;
double msf_localization::GNSSData::origin_altitude = 0.0;
bool msf_localization::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian msf_localization::GNSSData::geo_converter;
