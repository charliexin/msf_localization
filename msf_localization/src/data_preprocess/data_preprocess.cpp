...
#include "msf_localization/data_preprocess/data_preprocess.hpp"
#include "glog/logging.h"

namespace msf_localization {
void DataPreprocess::SetMotionInfo(float scan_period, VelocityData velocity_data) {
...
bool DataPreprocess::AdjustCloud(CloudData::CLOUD_PTR& input_cloud_ptr, CloudData::CLOUD_PTR& output_cloud_ptr) {
...
Eigen::Matrix3f DataPreprocess::UpdateMatrix(float real_time) {
